        ...
        <main>
            <div id="search-users">
                ...
                <div id="search-result">
                    <?php 
                    //solves the error of array to string 
                ...
                <!-- <div id="recent-chats"> -->
                <!-- SELECT DISTINCT message.to_uid,from_uid FROM `message` WHERE message.from_uid="U1520585398" OR message.to_uid='U1520585398'; -->
                    <!-- <?php 
                        // function recentUsers($conn,$uid)
                        // {
                        //     $recsql=mysqli_query($conn,"SELECT DISTINCT message.to_uid,from_uid FROM message WHERE message.from_uid='{$uid}' OR message.to_uid='{$uid}' ORDER BY timestamp DESC;");

                        //     if(mysqli_num_rows($recsql)>0)
                        //     {
                        //         $resultRec = mysqli_fetch_assoc($recsql);
                        //         return $resultRec['to_uid'];
                        //     }
                        //     else
                        //     {
                        //         return 'nnsnandnasd';
                        ...
                        // $RecentU=recentUsers($conn,$_SESSION['uid']);
                        // if($RecentU=='')
                        // {
                        //     echo "no recent";
                        // }
